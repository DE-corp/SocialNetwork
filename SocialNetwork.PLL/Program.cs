                    ...
                    case "1":
                        {
                            ...
                            try
                            {
                                ...
                                Console.WriteLine("Вы успешно вошли в социальную сеть! Добро пожаловать {0}", user.FirstName + Environment.NewLine);
                                        ...
                                        case "2":
                                            {
                                                ...
                                                Console.ForegroundColor = ConsoleColor.Green;
                                                Console.WriteLine("Ваш профиль успешно обновлён!" + Environment.NewLine);
                                                Console.ForegroundColor = ConsoleColor.White;
                            ...
                            catch (WrongPasswordException)
                            {
                                ...
                                Console.WriteLine("Пароль не корректный!" + Environment.NewLine);
                                Console.ForegroundColor = ConsoleColor.White;
                            }
                            catch (UserNotFoundException)
                            {
                                Console.ForegroundColor = ConsoleColor.Red;
                                Console.WriteLine("Пользователь не найден!" + Environment.NewLine);
                                Console.ForegroundColor = ConsoleColor.White;
                            }
                    ...
                    case "2":
                        {
                            ...
                            try
                            {
                                ...
                                Console.ForegroundColor = ConsoleColor.Green;
                                Console.WriteLine("Ваш профиль успешно создан. Теперь Вы можете войти в систему под своими учетными данными." + Environment.NewLine);
                                Console.ForegroundColor = ConsoleColor.White;
                            }
